        ...
        c = (function () {
          ...
          return (
            ...
            (o.prototype.addOrSubtract = function (e) {
              ...
              for (
                var a = new Uint8ClampedArray(s.length),
                  n = s.length - c.length,
                  d = 0;
                d < n;
                d++
            ...
            (o.prototype.multiplyPoly = function (e) {
              ...
              for (
                var r = this.coefficients,
                  ...
                  s = e.coefficients,
                  a = s.length,
                  n = new Uint8ClampedArray(c + a - 1),
                  d = 0;
                d < c;
                d++
              )
                for (var l = r[d], i = 0; i < a; i++)
                  n[d + i] = t.addOrSubtractGF(
                    n[d + i],
    ...
    function (o, e, r) {
      ...
      e.binarize = function (o, e, r, a) {
        ...
        for (var n = new s(e, r), d = 0; d < e; d++)
          for (var l = 0; l < r; l++) {
            var i = o[4 * (l * e + d) + 0],
              B = o[4 * (l * e + d) + 1],
              k = o[4 * (l * e + d) + 2];
            n.set(d, l, 0.2126 * i + 0.7152 * B + 0.0722 * k);
          }
        for (
          var u = Math.ceil(e / 8),
            C = Math.ceil(r / 8),
          ...
          for (var w = 0; w < u; w++) {
            ...
            if (h - v <= 24 && ((p = v / 2), f > 0 && w > 0)) {
              var b =
                (m.get(w, f - 1) + 2 * m.get(w - 1, f) + m.get(w - 1, f - 1)) /
                4;
              v < b && (p = b);
            }
            m.set(w, f, p);
        ...
        var g = t.BitMatrix.createEmpty(e, r),
          x = null;
        for (a && (x = t.BitMatrix.createEmpty(e, r)), f = 0; f < C; f++)
          for (w = 0; w < u; w++) {
            for (
              var M = c(w, 2, u - 3), L = c(f, 2, C - 3), N = ((P = 0), -2);
              N <= 2;
              N++
            )
              for (var I = -2; I <= 2; I++) P += m.get(M + N, L + I);
            var O = P / 25;
            for (N = 0; N < 8; N++)
              for (I = 0; I < 8; I++) {
                (d = 8 * w + N), (l = 8 * f + I);
                var z = n.get(d, l);
                g.set(d, l, z <= O), a && x.set(d, l, !(z <= O));
              }
          }
        return a ? { binarized: g, inverted: x } : { binarized: g };
      };
    },
    function (o, e, r) {
      "use strict";
          ...
          var c = i[r.dataMask],
            ...
            a = (function (o) {
              ...
              for (var c = 0, s = o.alignmentPatternCenters; c < s.length; c++)
                for (
                  var a = s[c], n = 0, d = o.alignmentPatternCenters;
                  n < d.length;
                  n++
                ) {
                  var l = d[n];
      ...
      function k(o) {
        ...
        var r = (function (o) {
          for (var e = 0, r = 0; r <= 8; r++)
            6 !== r && (e = d(o.get(r, 8), e));
          for (var t = 7; t >= 0; t--) 6 !== t && (e = d(o.get(8, t), e));
          var c = o.height,
            s = 0;
          for (t = c - 1; t >= c - 7; t--) s = d(o.get(8, t), s);
          for (r = c - 8; r < c; r++) s = d(o.get(r, 8), s);
        ...
        var t = (function (o, e, r) {
          ...
          if (t.ecBlocks.length > 1) {
            ...
            for (n = 0; n < B; n++) c[i + n].codewords.push(o.shift());
          }
          for (; o.length > 0; )
    ...
    function (o, e, r) {
      ...
      function n(o, e) {
        ...
        if (2 === s) {
          ...
          (a = Math.floor(l / 10)), (n = l % 10);
          r.push(48 + a, 48 + n), (t += a.toString() + n.toString());
        } else if (1 === s) {
          var l;
      ...
      function B(o, e) {
        for (
          var r = [], t = "", c = [8, 10, 12][e], s = o.readBits(c), n = 0;
          n < s;
          n++
        ) {
          var d = o.readBits(13),
      ...
      e.decode = function (o, e) {
        ...
        var B = new c.default(s, n),
          k = (function (o, e, r, t) {
            ...
            for (
              var s = e, a = r, n = o.zero, d = o.one;
              a.degree() >= t / 2;

            ) {
              var l = s,
                i = n;
              if (((n = d), (s = a).isZero())) return null;
              a = l;
              for (
                var B = o.zero,
                  k = s.getCoefficient(s.degree()),
                  u = o.inverse(k);
                a.degree() >= s.degree() && !a.isZero();
              ...
              if (
                ((d = B.multiplyPoly(n).addOrSubtract(i)),
                a.degree() >= s.degree())
              )
                return null;
            }
              ...
              for (var c = r.length, s = new Array(c), a = 0; a < c; a++) {
                for (var n = o.inverse(r[a]), d = 1, l = 0; l < c; l++)
                  a !== l &&
                    (d = o.multiply(
                      d,
                      t.addOrSubtractGF(1, o.multiply(r[l], n))
                    ));
      ...
      e.extract = function (o, e) {
        for (
          var r,
            ...
            n = c(e.topLeft, e.topRight, e.alignmentPattern, e.bottomLeft),
            d =
              ((s = a),
              {
    ...
    function (o, e, r) {
      ...
      function s(o, e, r, c) {
        ...
        for (
          ...
          if (
            r.get(v, h) !== f &&
            ((f = !f), l.push({ x: v, y: h }), l.length === c + 1)
          )
            break;
          if ((u += k) > 0) {
            if (P === d) break;
      ...
      function a(o, e, r, t) {
        var c,
          a = e.y - o.y,
          n = e.x - o.x,
          d = s(o, e, r, Math.ceil(t / 2)),
          l = s(o, { x: o.x - n, y: o.y - a }, r, Math.ceil(t / 2)),
          i = d.shift() + l.shift() - 1;
      ...
      function d(o, e, r) {
        try {
          var t = a(o, { x: -1, y: o.y }, r, e.length),
            c = a(o, { x: o.x, y: -1 }, r, e.length),
            s = a(
              o,
            ...
            C =
              (l.averageSize + i.averageSize + B.averageSize + k.averageSize) /
              4;
          return (
            u +
      ...
      function l(o, e) {
        ...
        for (
          var c = (r + t) / 2, s = Math.round(e.y);
          o.get(Math.round(c), s);
      ...
      function i(o, e, r, s, n) {
        ...
        try {
          (l = (function (o, e, r, s) {
            ...
            return { dimension: i, moduleSize: n };
          })(s, r, n, o)),
            (i = l.dimension),
            (B = l.moduleSize);
        } catch (o) {
            ...
            .map(function (e) {
              ...
              if (o.get(Math.floor(r), Math.floor(s))) {
                ...
                return {
                  ...
                  y: s,
                  score:
                    d({ x: Math.floor(r), y: Math.floor(s) }, [1, 1, 1], o) +
                    t({ x: r, y: s }, f),
                };
              }
            })
      ...
      e.locate = function (o) {
                ...
                var n = 0,
                  ...
                  i = function (e) {
                    ...
                    if (s === d) n++;
                      ...
                      (l = [l[1], l[2], l[3], l[4], n]), (n = 1), (d = s);
                      var i = c(l) / 7,
                        B =
                          Math.abs(l[0] - i) < i &&
                          Math.abs(l[1] - i) < i &&
                          Math.abs(l[2] - 3 * i) < 3 * i &&
                          Math.abs(l[3] - i) < i &&
                          Math.abs(l[4] - i) < i &&
                          !s,
                        k = c(l.slice(-3)) / 3,
                      ...
                      if (B) {
                        var C = e - l[3] - l[4],
                          m = C - l[2],
                          f = { startX: m, endX: C, y: t };
                        (w = r.filter(function (o) {
                          return (
                            (m >= o.bottom.startX && m <= o.bottom.endX) ||
                            (C >= o.bottom.startX && m <= o.bottom.endX) ||
                            (m <= o.bottom.startX &&
                              C >= o.bottom.endX &&
                              l[2] / (o.bottom.endX - o.bottom.startX) < 1.5 &&
                              l[2] / (o.bottom.endX - o.bottom.startX) > 0.5)
                          );
                        })).length > 0
                          ? (w[0].bottom = f)
                          : r.push({ top: f, bottom: f });
                      }
                      if (u) {
                        var w,
                          P = e - l[4],
                          v = P - l[3];
                        f = { startX: v, y: t, endX: P };
                        (w = a.filter(function (o) {
                          return (
                            (v >= o.bottom.startX && v <= o.bottom.endX) ||
                            (P >= o.bottom.startX && v <= o.bottom.endX) ||
                            (v <= o.bottom.startX &&
                              P >= o.bottom.endX &&
                              l[2] / (o.bottom.endX - o.bottom.startX) < 1.5 &&
                              l[2] / (o.bottom.endX - o.bottom.startX) > 0.5)
        ...
        var u = (function (o, e, r) {
            ...
            return (
              k >= B && k >= u
                ? ((d = (c = [e, o, r])[0]), (l = c[1]), (i = c[2]))
                : u >= k && u >= B
                ? ((d = (s = [o, e, r])[0]), (l = s[1]), (i = s[2]))
                : ((d = (a = [o, r, e])[0]), (l = a[1]), (i = a[2])),
              (i.x - l.x) * (d.y - l.y) - (i.y - l.y) * (d.x - l.x) < 0 &&
                ((d = (n = [i, d])[0]), (i = n[1])),
              { bottomLeft: d, topLeft: l, topRight: i }
            );
